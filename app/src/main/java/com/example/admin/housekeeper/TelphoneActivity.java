...
public class TelphoneActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, Toolbar.OnMenuItemClickListener {
...
//    private ListView        mView;
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                //跳转页面
                Intent intent = new Intent(TelphoneActivity.this,showClassActivity.class);
                //铜鼓点击的位置获取点击位置所对应的数据
